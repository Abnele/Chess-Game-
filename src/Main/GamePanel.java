    ...
    public void run()
    {
        ...
        while(!gameIsOver){
            ...
            if (delta >= 1) {
                ...
                System.out.print("\rUpdate Iterations: "  + updateIterations + " IsInCheck: " + isInCheck + " isCheckMated: " + isInCheckMate + " Moveable Piece: " + moveablePiece + " MC: " + moveableCol + " MR: " + moveableRow + " CheckingPieces: " + size(checkingPieces));
                updateIterations++;
