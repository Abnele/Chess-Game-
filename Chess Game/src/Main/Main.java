...
public class Main {
    ...
    public static void main(String [] args){
        ...
        // Debugging Settings
        boolean runDebuggingLoops = false;
        ...
        // Add the home screen  to the window
        homeScreen.setLayout(null); /// Gets rid of layouts to manually add GUI's in the future
        ...
        homeScreen.start(); /// Launches the game
